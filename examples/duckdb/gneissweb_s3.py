...
result = con.execute("""
    SELECT h.url_host_registered_domain, h.crawl, h.surt_host_name, h.hcrank, h.hcrank10, g.*
    FROM 's3://commoncrawl/projects/host-index-testing/v2/crawl=CC-MAIN-2021-49/*.parquet' h
    JOIN 's3://commoncrawl/projects/gneissweb-annotation-testing-v1/hosts/crawl=CC-MAIN-2021-49/*.parquet' g
